...
#time.sleep(2) #wait a few second to  initialize the 4 Pi connections
...
print("gpio pwm3 freq: {}".format(pi3.get_PWM_frequency(pwm3)))
pi4.set_PWM_frequency(pwm4, 1200)
print("gpio pwm4 freq: {}".format(pi4.get_PWM_frequency(pwm4)))
