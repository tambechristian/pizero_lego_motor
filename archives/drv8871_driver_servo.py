...
while 1:
	...
	if pressed_keys[K_d] and pressed_keys[K_LEFT]:
		...
		current_dc1 = position1
		for position1 in range (current_dc1, max_dc1, 1): #18 = (255-128) /7
			pi1.set_PWM_dutycycle(hw_pwm1, position1)
			#time.sleep(0.05)
			current_dc1 = position1
		#for position1 in range (curr_pulse1, 2000, 286): #2500 - 500 = 2000 / 7(servo lego steps)  =285.7
		#	pi1.set_servo_pulsewidth(hw_pwm1, position1)
	elif pressed_keys[K_LEFT]:
		print("key LEFT has been pressed")
		pi1.set_PWM_dutycycle(hw_pwm1, 0)
		current_dc2 = position2
		for position2 in range(current_dc2, max_dc2, 1):
			pi2.set_PWM_dutycycle(hw_pwm2, position2)
			#time.sleep(0.05)
			current_dc2 = position2
		#pi1.set_servo_pulsewidth(hw_pwm1, 0)
		#for position2 in range (curr_pulse2, 2000, 286):
		#	pi2.set_servo_pulsewidth(hw_pwm2, position2)
