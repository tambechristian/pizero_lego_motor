...
while 1:
	...
	if pressed_keys[K_d] and pressed_keys[K_LEFT]:
		...
		if (dc1 <255):
			...
			#else:
			#	pi2.set_PWM_dutycycle(hw_pwm2,
		#if (dc1 >= 254 and dc2 <=0):
		#	print("maximum right steer reached, steer left")
		#	break
		#dc1 = dc1+1
		#pi1.set_PWM_dutycycle(hw_pwm1, dc1)
		#dc2 = dc2-1
		...
		if (dc2 <255):
			...
			if (dc1 >0):
				dc1 = dc1 -1
				pi1.set_PWM_dutycycle(hw_pwm1, dc1)
		#if (dc2 >= 254 and dc1 <=0 ):
		#	print("maximum left steer reached, steer right")
		#	break
		#dc2 = dc2+1
		#pi2.set_PWM_dutycycle(hw_pwm2, dc2)
		#dc1 = dc1 - 1
